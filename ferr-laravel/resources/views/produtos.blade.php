            ...
            <table class="table table-hover">
                ...
                <tbody>
                    <tr>
                        ...
                        <div class="media">
                            <a class="thumbnail pull-left" href="#"> <img class="media-object" src="images/andaime.jpg" style="width: 72px; height: 72px;"> </a>
                    ...
                    <tr>
                        <td class="col-md-6">
                        <div class="media">
                            <a class="thumbnail pull-left" href="#"> <img class="media-object" src="images/pincel.jpg" style="width: 72px; height: 72px;"> </a>
                            <div class="media-body">
                    ...
                    <tr>
                        <td class="col-md-6">
                        <div class="media">
                            <a class="thumbnail pull-left" href="#"> <img class="media-object" src="images/escada.jpg" style="width: 72px; height: 72px;"> </a>
                            <div class="media-body">
